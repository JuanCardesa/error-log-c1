...
-- Drizzle emitio el SELECT leyendo `rollover_source` de la tabla vieja, que no lo tiene:
...
INSERT INTO `__new_anki_sync`("id", "namespace", "profile", "url", "source_deck", "target_deck", "last_synced_at", "notes_seen", "rollover_hour", "rollover_source") SELECT "id", "namespace", "profile", "url", "source_deck", "target_deck", "last_synced_at", "notes_seen", "rollover_hour", NULL FROM `anki_sync`;--> statement-breakpoint
