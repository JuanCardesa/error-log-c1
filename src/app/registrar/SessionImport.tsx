...
import header from './session.module.css';
...
export function SessionImport({ today, openSessions, subcategorySuggestions }: {
  ...
  return <section className={header.panel} aria-label="Importar una tanda de estudio">
    ...
    {problem !== '' && <p role="alert" className={header.fieldError}>{problem}</p>}
  </section>;
}
